...
public class SnowmanRacewayWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SnowmanRacewayWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SnowmanRacewayIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SnowmanRacewayIW/InitOutcome.xml").getDocumentElement();
